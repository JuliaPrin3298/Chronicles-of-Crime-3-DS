...
var _sprwj = sprite_get_width(spr_continuar)/2;
var _sprhj = sprite_get_height(spr_continuar)/2;
...
draw_sprite_ext(spr_continuar, 0, _x1j, _y1j, bscale, bscale, 0, c_white, balpha);
